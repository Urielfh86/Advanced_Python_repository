...
class FPSStats:
    ...
    def __set_fps_surface(self):
        ...
        self.__fps_surface = self.__font.render(f"Update = {self.__logic_frames} -  Render = {self._render_frames}", True, cfg_item("game", "foreground_color"), cfg_item("game", "background_color"))
